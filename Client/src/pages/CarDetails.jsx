                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 mt-8">
                            ...
                            {isLoaded && car.coordinates && car.coordinates.lat ? (
                                ...
                                <div className="h-64 bg-gray-50 rounded-xl flex items-center justify-center text-gray-400 border-2 border-dashed border-gray-200">
                                    {isLoaded 
                                        ? "Location coordinates not available for this car." 
                                        : "Loading Map..."
                                    }
                                </div>
                            )}
