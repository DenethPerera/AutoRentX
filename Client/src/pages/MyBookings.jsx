  ...
  if (bookings.length === 0)
    return (
      <div className="text-center py-20">
        ...
        <a href="/cars" className="bg-blue-600 text-white px-6 py-2 rounded-lg">
          Browse Cars
        </a>
      </div>
    );
    ...
    <div className="container mx-auto p-6 min-h-screen">
            ...
            <div className="p-6 flex-1 flex flex-col justify-between">
              ...
              {booking.status === "approved" ? (
                    ...
                    <a
                      href={
                        booking.car.coordinates
                          ? `https://www.google.com/maps/dir/?api=1&destination=${booking.car.coordinates.lat},${booking.car.coordinates.lng}`
                ...
                <div className="mt-4 pt-4 border-t border-gray-100 flex items-center gap-2 text-yellow-600 bg-yellow-50 p-3 rounded-lg">
                  ...
                  <p className="text-sm">
                    Contact details will be revealed once the owner approves
                    your booking.
                  </p>
                </div>
              )}
      ...
      {activeChat && (
        <div className="fixed bottom-0 right-0 z-50">
          <ChatWidget receiverId={activeChat} receiverName="Owner" />
          <button
